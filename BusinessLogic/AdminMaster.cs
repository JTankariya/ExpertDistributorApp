...
namespace BAL
{
    public class AdminMaster
    {
        ...
        public int SaveAdmin()
        {
            ...
            int result = DBHelper.ExecuteNonQuery("SaveAdminMaster", param, true);
        ...
        {
            DataTable dt = DBHelper.GetDataTable("GetAllAdminMaster", null, true);
        ...
        public static AdminMaster GetAdminByID(string ID)
        {
            Dictionary<string, object> param = new Dictionary<string, object>();
            param.Add("@ID", ID);
            DataTable dt = DBHelper.GetDataTable("GetAdminByID", param, true);
            if (dt != null && dt.Rows.Count > 0)
            {
        ...
        public static int Delete(int ID)
        {
            Dictionary<string, object> param = new Dictionary<string, object>();
            param.Add("@ID", ID);
            return DBHelper.ExecuteNonQuery("DeleteAdminByID", param, true);
        }
    }
}
